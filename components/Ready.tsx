...
export default function Ready() {
  ...
  const phrase = ["Ready", "to whisk", "the project"];
  ...
  return (
    <section
      className="w-full relative z-30 min-h-screen sm:h-screen xm:h-screen bg-marquee padding-y rounded-t-[20px] mt-[-20px]"
      ref={container}
    >
