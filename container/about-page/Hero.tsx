...
import { aboutImg, ochiside } from "@/public";
                ...
                <div className="w-[50%] flex flex-col gap-y-[40px] sm:w-full xm:w-full">
                  <div className="flex flex-col gap-y-[20px]">
                    <p className="paragraph font-NeueMontreal text-secondry">
                      We are Studio Bizkit — a bunch of young graduates who
                      <br />
                      found unexpected joy in solving problems with design
                      <br />
                      and code. Our journey began in Bangalore, where a surprise
                      <br />
                      meeting sparked a shared passion to create and innovate
                      together.
                    </p>
                  </div>
                  <div className="flex flex-col gap-y-[20px]">
                    <p className="paragraph font-NeueMontreal text-secondry">
                      We believe every challenge is a chance to bake something
                      <br />
                      fresh and meaningful — mixing creativity with technology
                      <br />
                      to deliver solutions that not only work but inspire.
                    </p>
                  </div>
                </div>
